    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('common.edit_flipbook')</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form id="kt_form_flipbook" action="{{ route('admin.flipbooks.update', $flipbook->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-header border-0 pt-6">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-semibold fs-7">@lang('common.edit_flipbook_content')</span>
                            </h3>
                        </div>
                        <div class="card-body">
                            <!-- Tabs -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-5">
                                            ...
                                            <select name="status" class="form-select form-select-solid" required>
                                                <option value="draft" {{ $flipbook->status === 'draft' ? 'selected' : '' }}>@lang('common.draft')</option>
                                                <option value="published" {{ $flipbook->status === 'published' ? 'selected' : '' }}>@lang('common.published')</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.published_at')</label>
                                            <input type="datetime-local" name="published_at" class="form-control form-control-solid" value="{{ $flipbook->published_at ? $flipbook->published_at->format('Y-m-d\TH:i') : '' }}"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="kt_tab_english" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 mb-5">
                                            ...
                                            <input type="text" name="translations[en][title]" class="form-control form-control-solid" value="{{ $translations['en'] ? $translations['en']->title : '' }}" placeholder="@lang('common.title_placeholder')"/>
                                            <div class="form-text">@lang('common.title_optional')</div>
                                        </div>
                                        <div class="col-12 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.subtitle_english')</label>
                                            <input type="text" name="translations[en][subtitle]" class="form-control form-control-solid" value="{{ $translations['en'] ? $translations['en']->subtitle : '' }}" placeholder="@lang('common.subtitle_placeholder')"/>
                                ...
                                <div class="tab-pane fade" id="kt_tab_arabic" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 mb-5">
                                            ...
                                            <input type="text" name="translations[ar][title]" class="form-control form-control-solid" value="{{ $translations['ar'] ? $translations['ar']->title : '' }}" placeholder="@lang('common.title_placeholder')"/>
                                            <div class="form-text">@lang('common.title_optional')</div>
                                        </div>
                                        <div class="col-12 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.subtitle_arabic')</label>
                                            <input type="text" name="translations[ar][subtitle]" class="form-control form-control-solid" value="{{ $translations['ar'] ? $translations['ar']->subtitle : '' }}" placeholder="@lang('common.subtitle_placeholder')"/>
                                            <div class="form-text">@lang('common.subtitle_optional')</div>
                                        </div>
                                    </div>
                                </div>
        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                Swal.fire({
                    ...
                    window.location.href = "{{ route('admin.flipbooks.index') }}";
                });
            } else {
                Swal.fire({
