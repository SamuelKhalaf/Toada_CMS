        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Story</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                            ...
                            <div class="mb-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <textarea name="translations[en][body]" class="form-control form-control-solid" rows="10">{{ $translations['en']->body ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <textarea name="translations[ar][body]" class="form-control form-control-solid" rows="10">{{ $translations['ar']->body ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-5">
                                        ...
                                        <input type="text" name="featured_image" class="form-control form-control-solid" value="{{ $story->featured_image }}" placeholder="Path from storage"/>
                                    </div>
                                </div>
                            </div>
                        </div>
