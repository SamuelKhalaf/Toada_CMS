        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('common.create_story')</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card">
                        <div class="card-header border-0 pt-6">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted mt-1 fw-semibold fs-7">@lang('common.create_new_story')</span>
                            </h3>
                        </div>
                        <div class="card-body">
                            <!-- Tabs -->
                                ...
                                <div class="tab-pane fade show active" id="kt_tab_basic" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-5">
                                            ...
                                            <input type="text" name="slug" class="form-control form-control-solid" placeholder="@lang('common.auto_generate_slug')"/>
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <input type="text" name="tags" class="form-control form-control-solid" placeholder="@lang('common.tags_placeholder')"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="kt_tab_english" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <textarea id="tinymce_en_body" name="translations[en][body]" class="form-control form-control-solid" rows="15"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="kt_tab_arabic" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <textarea id="tinymce_ar_body" name="translations[ar][body]" class="form-control form-control-solid" rows="15"></textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-10">
                                            ...
                                            <div class="image-upload-wrapper">
                                                <input type="hidden" name="featured_image" id="featured_image_path" class="image-path-input">
                                ...
                                <div class="tab-pane fade" id="kt_tab_seo" role="tabpanel">
                                    <div class="row">
                                        <div class="col-12 mb-5">
                                            ...
                                            <input type="text" name="translations[en][meta_title]" class="form-control form-control-solid" maxlength="60"/>
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <textarea name="translations[en][meta_description]" class="form-control form-control-solid" rows="3" maxlength="160"></textarea>
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <input type="text" name="translations[ar][meta_title]" class="form-control form-control-solid" maxlength="60"/>
                                            <div class="form-text">@lang('common.recommended_chars_50_60')</div>
                                        </div>
                                        <div class="col-12 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.meta_description_arabic')</label>
                                            <textarea name="translations[ar][meta_description]" class="form-control form-control-solid" rows="3" maxlength="160"></textarea>
                                            <div class="form-text">@lang('common.recommended_chars_150_160')</div>
                                        </div>
                                    </div>
                                </div>
