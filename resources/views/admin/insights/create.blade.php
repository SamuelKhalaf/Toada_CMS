    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('common.create_insight')</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form id="kt_form_insight" action="{{ route('admin.insights.store') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-header border-0 pt-6">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">@lang('common.insight_details')</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">@lang('common.create_new_insight')</span>
                            </h3>
                        </div>
                        <div class="card-body">
                            <!-- Tabs -->
        ...
        .then(data => {
            if (data.status === 'success') {
                if (imageType === 'featured') {
                    ...
                    const template = wrapper.querySelector('.gallery-item');
