        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Edit Insight</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    ...
                    <div class="card">
                        <div class="card-header border-0 pt-6">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">Insight Details</span>
                            </h3>
                        </div>
                        <div class="card-body">
                            <!-- Basic Info -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-5">
                                        ...
                                        <select name="status" class="form-select form-select-solid" required>
                                            <option value="draft" {{ $insight->status === 'draft' ? 'selected' : '' }}>Draft</option>
                                            <option value="published" {{ $insight->status === 'published' ? 'selected' : '' }}>Published</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-5">
                            ...
                            <div class="mb-10">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-5">
                                        ...
                                        <input type="text" name="featured_image" class="form-control form-control-solid" value="{{ $insight->featured_image }}" placeholder="Path from storage"/>
                                    </div>
                                </div>
                            </div>
                        </div>
