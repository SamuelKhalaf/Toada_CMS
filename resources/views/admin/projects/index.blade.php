        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('common.projects')</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">@lang('common.projects')</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-projects-table-filter="search"
                        ...
                        <div class="card-toolbar">
                            <!--begin::Toolbar-->
                            <div class="d-flex justify-content-end" data-kt-projects-table-toolbar="base">
                                <!--begin::Add project-->
                                <!-- <a href="{{ route('admin.projects.create') }}" class="btn btn-primary">
                                    <span class="svg-icon svg-icon-2">
                                        <i class="fa-solid fa-plus"></i>
                                    </span>
                                    @lang('common.add_project')
                                </a> -->
                                <!--end::Add project-->
                            </div>
                            <!--end::Toolbar-->
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_projects">
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-150px">@lang('common.date_range')</th>
                                <th class="min-w-150px">@lang('common.location')</th>
...
@section('scripts')
    <script>
        $('#kt_table_projects').on('draw.dt', function () {
        ...
        // Handle delete
        $(document).on("click", '[data-kt-projects-table-filter="delete_row"]', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('admin.projects.destroy', ':id') }}".replace(':id', projectId),
                        type: 'DELETE',
