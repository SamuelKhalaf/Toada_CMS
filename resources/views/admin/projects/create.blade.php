...
@section('title', __('common.create_project'))
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('common.create_project')</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                <form id="kt_form_project" action="{{ route('admin.projects.store') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-header border-0 pt-6">
                            <h3 class="card-title align-items-start flex-column">
                                <span class="card-label fw-bold fs-3 mb-1">@lang('common.project_details')</span>
                                <span class="text-muted mt-1 fw-semibold fs-7">@lang('common.create_new_project')</span>
                            </h3>
                        </div>
                        <div class="card-body">
                            <!-- Tabs -->
                                ...
                                <div class="tab-pane fade show active" id="kt_tab_basic" role="tabpanel">
                                    <div class="row">
                                        <div class="col-md-6 mb-5">
                                            ...
                                            <input type="text" name="date_range" class="form-control form-control-solid" placeholder="e.g., December 15-17, 2025"/>
                                        </div>
                                        <div class="col-md-6 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.location_text')</label>
                                            <input type="text" name="location_text" class="form-control form-control-solid" placeholder="e.g., Malham Location"/>
                                        </div>
                                        <div class="col-12 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.location_url_google_maps')</label>
                                            <input type="url" name="location_url" class="form-control form-control-solid" placeholder="https://www.google.com/maps/..."/>
                                        </div>
                                        <div class="col-md-6 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.register_url_arabic')</label>
                                            <input type="url" name="register_url_ar" class="form-control form-control-solid" placeholder="https://..."/>
                                        </div>
                                        <div class="col-md-6 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.register_url_english')</label>
                                            <input type="url" name="register_url_en" class="form-control form-control-solid" placeholder="https://..."/>
                                        </div>
                                        <div class="col-md-6 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.slug')</label>
                                            <input type="text" name="slug" class="form-control form-control-solid" placeholder="Auto-generated from title"/>
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <input type="text" name="tags" class="form-control form-control-solid" placeholder="Event, Saudi Arabia, 2025 (comma-separated)"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="kt_tab_english" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <textarea name="translations[en][description]" class="form-control form-control-solid" rows="5" required></textarea>
                                        </div>
                                        <div class="col-12 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.badge_text')</label>
                                            <input type="text" name="translations[en][badge_text]" class="form-control form-control-solid" placeholder="e.g., Upcoming Event"/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade" id="kt_tab_arabic" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-5">
                                            ...
                                            <textarea name="translations[ar][description]" class="form-control form-control-solid" rows="5" required></textarea>
                                        </div>
                                        <div class="col-12 mb-5">
                                            <label class="fw-semibold fs-6 mb-2">@lang('common.badge_text')</label>
                                            <input type="text" name="translations[ar][badge_text]" class="form-control form-control-solid" placeholder="نص الشارة"/>
                                        </div>
                                    </div>
                                </div>
