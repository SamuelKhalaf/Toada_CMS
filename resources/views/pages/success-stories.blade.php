...
@php
    ...
    $getContent = function($sectionKey, $default = '') use ($contentService, $currentLang) {
        $content = $contentService->getContent('success-stories', $sectionKey, $currentLang);
    ...
    $getImage = function($sectionKey) use ($contentService, $currentLang) {
        return $contentService->getImage('success-stories', $sectionKey, $currentLang);
    };
    ...
    $heroDescription = $getContent('hero_description', '');
    $heroBackgroundImage = $getImage('hero_background_image');
    $storiesSectionTitleData = $getContentWithHighlight('stories_section_title');
...
@section('meta')
    <meta content="Success Stories" property="og:title"/>
    <meta content="Success Stories" property="twitter:title"/>
@endsection
                                ...
                                <div class="_12-column-grid">
                                    ...
                                    <div id="w-node-_766d46bb-8db5-d76b-e072-7eee1ce6e0e7-c47d89ea" class="w-dyn-list">
                                        <div role="list" class="collection-list w-dyn-items">
                                            ...
                                            @empty
                                                <div role="listitem" class="w-dyn-item">
                                                    <div class="text-muted p-5">{{ __('common.no_items_found') ?? 'No stories found.' }}</div>
                                                </div>
                                            @endforelse
                                            <!-- <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'unesco-creativity-report') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/unesco-creativity-report.webp') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        </div>
                                                        <div class="blog-content">
                                                            <div class="blog-top">
                                                                <div class="date-length">
                                                                    <div class="display-xs">2021-2022</div>
                                                                    <div class="label-square"></div>
                                                                    <div class="display-xs">Research</div>
                                                                </div>
                                                            </div>
                                                            <div class="blog-bottom">
                                                                <div class="display-large">Reshaping Policies for Creativity Report – Addressing culture as a global public good</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'world-cities-culture-forum') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/world-cities-culture-forum.png') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        ...
                                                        <div class="blog-content">
                                                            <div class="blog-top">
                                                                <div class="date-length">
                                                                    <div class="display-xs">2012-2022</div>
                                                                    <div class="label-square"></div>
                                                                    <div class="display-xs">Research & Facilitation</div>
                                                                </div>
                                                            </div>
                                                            <div class="blog-bottom">
                                                                <div class="display-large">World Cities Culture Forum</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'tencent-hq') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/tencent-hq.webp') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        ...
                                                        <div class="blog-content">
                                                            <div class="blog-top">
                                                                <div class="date-length">
                                                                    <div class="display-xs">2022-2023</div>
                                                                    <div class="label-square"></div>
                                                                    <div class="display-xs">Strategy & Planning</div>
                                                                </div>
                                                            </div>
                                                            <div class="blog-bottom">
                                                                <div class="display-large">Tencent HQ</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'king-abdullah-sports-city') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/king-abdullah-sports-city.jpg') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        ...
                                                        <div class="blog-content">
                                                            <div class="blog-top">
                                                                <div class="date-length">
                                                                    <div class="display-xs">2024</div>
                                                                    <div class="label-square"></div>
                                                                    <div class="display-xs">Events</div>
                                                                </div>
                                                            </div>
                                                            <div class="blog-bottom">
                                                                <div class="display-large">King Abdullah Sports City</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'rugby-world-cup-2023') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/rugby-world-cup-2023.jpg') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        ...
                                                        <div class="blog-content">
                                                            <div class="blog-top">
                                                                <div class="date-length">
                                                                    <div class="display-xs">2023</div>
                                                                    <div class="label-square"></div>
                                                                    <div class="display-xs">Sports</div>
                                                                </div>
                                                            </div>
                                                            <div class="blog-bottom">
                                                                <div class="display-large">Rugby World Cup 2023 Opening</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'fina-swimming-championship') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/fina-swimming-championship.jpg') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        ...
                                                        <div class="blog-content">
                                                            ...
                                                            <div class="blog-bottom">
                                                                <div class="display-large">FINA Swimming World Championship</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                            ...
                                            <div role="listitem" class="w-dyn-item">
                                                <a data-w-id="d30d9cc0-7701-ebb8-8f61-2be40c414cd7" href="{{ route('story-description', 'ramadan-season-2024') }}" class="blog-item w-inline-block">
                                                    <div class="blog-item-wrap">
                                                        <div class="blog-image-wrap">
                                                            <img src="{{ asset('images/success-stories/ramadan-season-2024.jpg') }}" loading="lazy" data-w-id="499455ca-44c1-24ac-43ee-e018379e1839" alt="" class="blog-image"/>
                                                            <div data-w-id="51183ba4-c03f-93d2-728e-f6cfd3c6bc83" class="read-more-wrap">
                                                                <div class="display-xs">Read More</div>
                                                                <img src="{{ asset('images/arrow-white.svg') }}" loading="lazy" alt="" class="read-more-arrow"/>
                                                            </div>
                                                        ...
                                                        <div class="blog-content">
                                                            <div class="blog-top">
                                                                <div class="date-length">
                                                                    <div class="display-xs">2024</div>
                                                                    <div class="label-square"></div>
                                                                    <div class="display-xs">Ministry of Culture</div>
                                                                </div>
                                                            </div>
                                                            <div class="blog-bottom">
                                                                <div class="display-large">Ramadan Season</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
