                ...
                <div class="nav-link-list">
                    <div class="nav-link-item">
                        <div class="nav-link-wrapper _1">
                            ...
                            <a href="{{ route('home') }}" class="nav-link {{ request()->routeIs('home') ? 'w--current' : '' }}">Home</a>
                        </div>
                    </div>
                    <div class="nav-link-item">
                        <div class="nav-link-wrapper _2">
                            <div class="display-xs">02.</div>
                            <a href="{{ route('about') }}" class="nav-link {{ request()->routeIs('about') ? 'w--current' : '' }}">About</a>
                        </div>
                    </div>
                    <div class="nav-link-item">
                        <div class="nav-link-wrapper _3">
                            <div class="display-xs">03.</div>
                            <a href="{{ route('services') }}" class="nav-link {{ request()->routeIs('services') ? 'w--current' : '' }}">Services</a>
                        </div>
                    </div>
                    <div class="nav-link-item">
                        <div class="nav-link-wrapper _5">
                            <div class="display-xs">04.</div>
                            <a href="{{ route('insights') }}" class="nav-link {{ request()->routeIs('insights*') ? 'w--current' : '' }}">Insights & Impact</a>
                        </div>
                    </div>
                    <div class="nav-link-item">
                        <div class="nav-link-wrapper _7">
                            <div class="display-xs">05.</div>
                            <a href="{{ route('contact') }}" class="nav-link {{ request()->routeIs('contact') ? 'w--current' : '' }}">Contact</a>
                        </div>
                    </div>
                </div>
