        ...
        return DataTables::of($stories)
            ...
            ->addColumn('actions', function ($story) {
                $actions = '<div class="text-center">
                    <a href="' . route('admin.stories.edit', $story->id) . '" class="btn btn-light btn-active-light-primary btn-sm">
                        ' . __('common.edit') . '
                    </a>
                    <a href="#" class="btn btn-light btn-active-light-danger btn-sm" data-kt-stories-table-filter="delete_row"
